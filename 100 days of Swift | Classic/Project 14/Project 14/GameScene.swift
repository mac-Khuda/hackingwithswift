...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        let backgorund = SKSpriteNode(imageNamed: "whackBackground")
    ...
    func createEnemy() {
        ...
        if numRounds >= 30 {
            ...
            let finalScoreLabel = SKLabelNode(text: "Your score is: \(score)")
            finalScoreLabel.fontName = "Chalkduster"
            finalScoreLabel.position = CGPoint(x: 512, y: 310)
